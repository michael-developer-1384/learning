        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px-0">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">{{ __('Export Users') }}</h3>
            ...
            <div class="mt-10 sm:mt-0">
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px-0">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">{{ __('Import Users') }}</h3>
                            <p class="mt-1 text-sm text-gray-600">
                                {{ __('Import users from an Excel file.') }}
                            </p>
                        </div>
                    </div>
                    <div class="mt-5 md:mt-0 md:col-span-2">
                        <form action="{{ route('event.import_users') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="shadow sm:rounded-md sm:overflow-hidden">
                                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-4">
                                            <label for="users_file" class="block text-sm font-medium text-gray-700">Excel File</label>
                                            <input type="file" name="users_file" id="users_file" class="mt-1 block w-full" required>
                                        </div>
                                    </div>
                                </div>
